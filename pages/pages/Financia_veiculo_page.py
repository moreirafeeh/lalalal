...
class Financiamento():
    ...
    def validar_resultado(self):
        self.driver.elemento_por_texto('/html/body/app-root/app-simulation-result/div/div/div/app-slider/section/h2','xpath', 'Resultado da sua simulação', implicit=20)
